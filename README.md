...
![Last Commit](https://img.shields.io/github/last-commit/oferdebug/stocks-webapp-Github?style=for-the-badge&color=purple)
...
<img src="https://skillicons.dev/icons?i=nextjs,react,typescript,tailwind,mongodb,nodejs,vercel,git,github,vscode&perline=5" />
...
```mermaid
graph LR
    A[📝 ESLint] --> B[✅ Type-Safe Code]
    C[🎯 TypeScript] --> B
    D[🔄 React Compiler] --> E[⚡ Optimized Build]
    F[🧪 Qodana] --> G[📊 Code Quality]
    H[🎨 Prettier] --> B
    I[📦 Yarn] --> E
```
...
```mermaid
gantt
    title NextTrade Development Roadmap
    dateFormat  YYYY-MM-DD
    section Phase 1 ✅
    Real-time Data        :done, 2025-12-01, 14d
    Portfolio Manager     :done, 2025-12-10, 10d
    section Phase 2 🚧
    Advanced Charts       :active, 2025-12-20, 20d
    AI Integration        :active, 2025-12-25, 25d
    section Phase 3 📅
    Mobile App            :2026-01-15, 30d
    Social Features       :2026-02-01, 20d
    section Phase 4 🚀
    Options Trading       :2026-03-01, 30d
    Algo Trading          :2026-04-01, 45d
```
...
[![GitHub followers](https://img.shields.io/github/followers/oferdebug?style=social)](https://github.com/oferdebug)
[![Twitter Follow](https://img.shields.io/twitter/follow/oferdebug?style=social)](https://twitter.com/oferdebug)
